...
# 
# IMPORTANTE: 
# para su ejecucion mediante spark-submit se setearon las siguientes variables de entorno dentro de C:\programas\spark\conf\spark-env.cmd
...
if __name__ == "__main__":
    ...
    if cp.delimitador is not None:
        ...
        #agregado de columnas adicionales
        if cp.cols_to_add is not None:
